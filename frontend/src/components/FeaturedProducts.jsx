...
//                                 <div key={product._id} className='w-full sm:w-1/2 lg:w/13 xl:w-1/4
//                                 flex-shrink-0 px-2'>
...
//                                                 className='w-full h-48 obejct-cover transition-transform duration-300
//                                             ease-in-out hover:scale-110'></img>
//                                         </div>
//                                         <div className='p-4'>
...
//                         </div>
//                     </div>
//                     {/* <button onClick={prevSlide} disabled={isStartDisabled} className={`absolute top-1/2 -left-4
//                     transform -translata-y-1/2 p-2 rounded-full transition-colors duration-300 ${isStartDisabled ?
//                             'bg-gray-400 cursor-not-allowed' : 'bg-emerald-600 hover:bg-emerald-500'}`}>
//                         <ChevronLeft className='w-6 h-6'></ChevronLeft>
//                     </button>
//                     <button onClick={nextSlide} disabled={isEndDisabled} className={`absolute top-1/2 -left-4
//                     transform -translata-y-1/2 p-2 rounded-full transition-colors duration-300 ${isEndDisabled ?
//                             'bg-gray-400 cursor-not-allowed' : 'bg-emerald-600 hover:bg-emerald-500'}`}>
