...
//         }
//         await redis.set('featured_products', JSON.stringify(feautredProducts))
...
//     } catch (error) {
//         console.log('error in createdProduct', error.message)
//         res.status(500).json({ message: 'server error', error: error.message })
//     }
// }
...
// //         res.json(products)
// //     } catch (error) {
// //         console.log('error in getrecommendation', error.message)
// //         res.status(500).json({ message: 'server error', error: error.message })
// //     }
// // }
// export const getRecommendedProducts = async (req, res) => {
